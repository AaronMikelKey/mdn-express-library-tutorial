...
exports.book_delete_get = function(req, res, next) {
  async.parallel({
    ...
    //Success, then render
    res.render('book_delete', { title: 'Delete Book', authors: results.authors, genres: results.genres, book: results.book, book_instances: results.book_instance  });
});
};
...
exports.book_delete_post = function(req, res, next) {
  async.parallel({
    ...
    if (results.book_instance.length > 0) {
        ...
        res.render('book_delete', { title: 'Delete Book', title: 'Delete Book', authors: results.authors, genres: results.genres, book: results.book, book_instances: results.book_instance });
        return;
    }
    else {
